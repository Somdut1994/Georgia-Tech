...
for run in range(10):
	...
	while i<len(Activities_10):
		dels.append(Activities_10[i+1][0]-Activities_10[i][0])
		if i==0:
	...
	delaylog.append(sum(dels)/len(dels))
	runtime.append(time.clock()-start)
	...
	while i<len(Activities_11):
		dels.append(Activities_11[i+1][0]-Activities_11[i][0])
		if i==0:
	...
	while i<len(Activities_12):
		dels.append(Activities_12[i+1][0]-Activities_12[i][0])
		if i==0:
